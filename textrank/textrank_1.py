...
Adopted from https://github.com/summanlp/textrank
"""
...
def writeFiles(summary, keyphrases, fileName):
    ...
    keyphraseFile = io.open('results/' + fileName, 'w')
...
def main():
    ...
    for article in articles:
        ...
        with codecs.open(os.path.join("../data/articles", article), "r", encoding='utf-8', errors='ignore') as articleFile:
